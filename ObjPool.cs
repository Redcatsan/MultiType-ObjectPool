...
{
    public static Dictionary<string,Stack<GameGameObject>> ObjPoolDic = new Dictionary<string,Stack<GameObject>>();
    ...
    public static GameObject Create(string name,Vector3? pos=  null,Quaternion? rot = null){//生成
